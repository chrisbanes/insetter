...
fun View.applySystemWindowInsetsToPadding(top: Boolean = false, bottom: Boolean = false, consume: Boolean) {
    noImpl()
}
...
fun View.applySystemWindowInsetsToMargin(top: Boolean = false, bottom: Boolean = false, consume: Boolean) {
    noImpl()
}
